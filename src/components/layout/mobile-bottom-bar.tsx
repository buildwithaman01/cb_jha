...
export function MobileBottomBar() {
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-[#0A0E14]/95 backdrop-blur-md border-t border-white/10"
      style={{ paddingBottom: "env(safe-area-inset-bottom)" }}
    >
      <div className="flex items-stretch h-[58px]">
        <a
          href="tel:+919470808655"
          className="flex-1 flex items-center justify-center gap-2 text-white/70 hover:text-white active:bg-white/5 transition-colors text-sm font-medium border-r border-white/10 touch-manipulation"
        >
        ...
        <a
          ...
          className="flex-1 flex items-center justify-center gap-2 bg-[#25D366] text-white text-sm font-semibold active:opacity-90 transition-opacity touch-manipulation border-r border-white/10"
        >
        ...
        <Link
          href="/contact"
          className="flex-1 flex items-center justify-center bg-accent text-accent-foreground text-sm font-heading font-bold active:opacity-90 transition-opacity touch-manipulation"
        >
          Enquire
        </Link>
      </div>
